...
function LoadBanner()
{
    if(IsMobilePlatform)
    {
        RTBrefresh("R-A-1646637-20", "Bottom");
RTBrefresh("R-A-1646637-22", "Fullscreen");

    } else
    {
        RTBrefresh("R-A-1646637-21", "Bottom");
RTBrefresh("R-A-1646637-23", "Center");
